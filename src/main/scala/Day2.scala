...
object Day2 extends Day(2):
  override def solve(): Unit =
    ...
    // Part 1
    println(sets.filter((e, i) => e.forall(d => d._1 <= 12 && d._2 <= 13 && d._3 <= 14)).map(_._2).sum)

    // Part 2
    println(sets.map((e, i) => (e.maxBy(_._1)._1, e.maxBy(_._2)._2, e.maxBy(_._3)._3)).map(e => e._1 * e._2 * e._3).sum)
